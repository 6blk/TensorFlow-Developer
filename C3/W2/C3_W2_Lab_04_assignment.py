...
with open("../../sources/BBC_News_Train/BBC_News_Train.csv", 'r') as csvfile:
...
source_file = '../../sources/BBC_News_Train/BBC_News_Train.csv'
sentences, labels = parse_data_from_file(source_file)
...
print(f'Unique items in the list = {list(set(labels))}')
print(f'Number of Unique items in the list = {len(list(set(labels)))}')
#
...
out_v = io.open('../../sources/vecs_c3_w2_l4_ass.tsv', 'w', encoding='utf-8')
out_m = io.open('../../sources/meta_c3_w2_l4_ass.tsv', 'w', encoding='utf-8')
